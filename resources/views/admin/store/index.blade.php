                    ...
                    <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $row->expire	 }}</td>
                                <td>
                                    <a href="{{ route('admin.store.edit', $row->id) }}" class="btn btn-primary btn-sm waves-effect btn-label waves-light"><i class="bx bx-cog label-icon"></i> Edit</a>
                                    <form action="{{ route('admin.store.destroy', $row) }}" method="POST" style="display: inline-block">
                                        {{csrf_field()}}
                                        {{method_field('DELETE')}}
