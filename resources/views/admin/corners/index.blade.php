...
{{--                        {{ __('messages.Clients and partners') }}--}}
                    ...
                    <p class="card-title-desc">All Items</p>
...
{{--                                    {{ __('messages.picture') }}--}}
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.corners.edit', $row->id) }}" class="btn btn-primary btn-sm waves-effect btn-label waves-light"><i class="bx bx-cog label-icon"></i> Edit</a>
                                    <form action="{{ route('admin.corners.destroy', $row) }}" method="POST" style="display: inline-block">
                                        {{csrf_field()}}
                                        {{method_field('DELETE')}}
                                        <button type="submit" title="حذف" onclick="return confirm({{ __('messages.Are you sure for delete this item?') }});" class="btn btn-danger btn-sm waves-effect btn-label waves-light">
                                            <i class="bx bx-cog label-icon"></i> Delete
                                        </button>
                                    </form>
                                </td>
                            </tr>
                            @empty
                            <tr>
                                <td colspan="4">There are no items at this time</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
